                ...
                function (Message $message, Channel $channel, Client $client) {
                    ...
                    if (!empty($data['offers'])) {
                        foreach ($data['offers'] as $v) {
                            echo 'Sending mail to client ' . $v['email'] . PHP_EOL;
                            OfferedDeal::send('email', $v); // sending email
                            $ids[] = $v['deal_id'];
                        }
                        ...
                        echo 'Sending mail to partner ' . $data['email'] . PHP_EOL;
                        AskToDeal::send('email', $data); // sending email
